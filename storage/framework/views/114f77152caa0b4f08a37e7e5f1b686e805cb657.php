            ...
            <div class="card author-box card-primary">
                <div class="card-body">
                    ...
                    <div class="author-box-name">
                        ...
                        <a href="#" title="<?php echo e($project->name); ?>" class="text-title"><?php echo e($project->name); ?></a>
                    ...
                    <p class="mb-1">
                        <span class="pr-2 text-nowrap mb-2 d-inline-block">
                            ...
                            <b></b> <?php echo e(__('Tasks')); ?>

                        </span>
                        <span class="text-nowrap mb-2 d-inline-block">
                            <i class="mdi mdi-comment-multiple-outline text-muted"></i>
                            <b></b> <?php echo e(__('Comments')); ?>
                    ...
                    <div class="float-right mt-sm-0 mt-3">
                        <a href="#" class="btn btn-sm btn-primary"><?php echo e(__('View More')); ?> <i class="dripicons-arrow-right"></i></a>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CDWeb2\Project_CDWeb1_NhomE - ver1\resources\views/projects/index.blade.php ENDPATH**/ ?>