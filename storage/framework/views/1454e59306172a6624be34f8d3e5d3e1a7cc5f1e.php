            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    ...
                    <div class="simple-footer">
                        Copyright &copy; <?php echo e(date('Y')); ?><div class="bullet"></div> Thu Duc College of Technology <div class="bullet"></div> Design By NhomE
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\web2\login\Project_CDWeb1_NhomE - Copy\resources\views/layouts/auth.blade.php ENDPATH**/ ?>